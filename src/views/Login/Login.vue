<template>
  <div class="login-container">
          ...
          <div class="content">
            <form action="##">
              <div class="input-text clearFix">
                <span></span>
                <input type="text" placeholder="邮箱/用户名/手机号" v-model="account.phone">
              </div>
              <div class="input-text clearFix">
                <span class="pwd"></span>
    ...
    <div class="copyright">
      ...
      <div class="address">地址：河南省驻马店市西平县</div>
...
const userLogin = async () => {
  if(account.phone && account.password){
    ...
    if(res.code === 200) {
      ...
      getUser()
      let toPath = route.query.rediect ? `/${route.query.rediect}` : '/home'
      console.log(toPath)
      router.push(toPath)
    }
  }
