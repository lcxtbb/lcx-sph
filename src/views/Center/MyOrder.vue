    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="(item, index) in myOrderInfo.records" :key="item.id">
                    <thead>
                        <tr>
                            <th colspan="5">
                    ...
                    <tbody>
                        <tr v-for="(data, index) in item?.orderDetailList">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="data.imgUrl" style="width: 100px; height: 100px;">
                                    <a class="block-text">{{ data.skuName }}</a>
                                    <span>x{{ data.skuNum }}</span>
                                    <a href="#" class="service">售后申请</a>
                                </div>
                            </td>
                            <td :rowspan="item?.orderDetailList.length" v-if="index === 0" width="8%" class="center">lcx</td>
                            ...
                            <td :rowspan="item?.orderDetailList.length"width="13%" v-if="index === 0" class="center">
                                <ul class="unstyled">
                                    <li>
            ...
            <Pagination :total="myOrderInfo.total" :continues="5" :pageSize="3" @pageEvent="changePage"/>
        </div>
        <!--猜你喜欢-->
        <div class="like">
            <h4 class="kt">猜你喜欢</h4>
...
const getMyOrder = async () => {
    const res = await reqMyOrder(pageNow, limit)
    console.log(res)
    if (res.code === 200) {
